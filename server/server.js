...
{
	// Avatar de base
	socket.avatar = "https://cdn-icons-png.flaticon.com/512/4305/4305692.png";
	...
	{
		// Transmet le message à tous les utilisateurs (broadcast)
		let iframeYT = '<iframe width="100%" height="100%" src="https://www.youtube.com/embed/' + message + '" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>'
