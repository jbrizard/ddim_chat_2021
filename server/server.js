...
io.sockets.on('connection', function(socket)
{
    ...
    socket.on('image', function(base64) 
    {
        ...
        socket.emit('new_message', {
            messageId:messageId, name:socket.name, message:'<img src="'+base64+'" width="100%">', 
            avatar:socket.avatar, isMe:true
        });
        // Envoie de l'image à tous les utilisateurs
        socket.broadcast.emit('new_message', {
            messageId:messageId, name:socket.name, message:'<img src="'+base64+'" width="100%">', 
            avatar:socket.avatar, isMe:false
        });
